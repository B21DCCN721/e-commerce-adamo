...
const DetailProductPage = () => {
    ...
    useEffect(() => {
        const fetchReviews = async () => {
            try {
                ...
                const response = await getListReviews(id);
                setReviews(
                    response
    ...
    useEffect(() => {
        if (selectedFilter === 'all') {
            ...
            searchParams.set("filter", String(selectedFilter));
        }
        setSearchParams(searchParams, { replace: true });
    }, [selectedFilter, setSearchParams, searchParams]);
